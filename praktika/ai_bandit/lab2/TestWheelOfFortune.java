...
public class TestWheelOfFortune {
    ...
    public final void test_R08_Constructor() throws Exception {
        ...
        WheelOfFortune wheel = new WheelOfFortune("test", 1.0, argCategoryNumberFields, argCategoryWins);
    ...
    public final void test_R09_GetNumberFields() {
        ...
        WheelOfFortune wheel = new WheelOfFortune("test", 1.0, argCategoryNumberFields, new double[]{ 1.5, 2.5 });
